...
CREATE INDEX IF NOT EXISTS "Order_phone_createdAt_idx" ON "Order"("phone", "createdAt");
CREATE UNIQUE INDEX IF NOT EXISTS "PaymentAttempt_merchantTradeNo_key" ON "PaymentAttempt"("merchantTradeNo");
...
CREATE UNIQUE INDEX IF NOT EXISTS "Refund_refundNo_key" ON "Refund"("refundNo");
CREATE UNIQUE INDEX IF NOT EXISTS "Shipment_orderId_key" ON "Shipment"("orderId");
CREATE UNIQUE INDEX IF NOT EXISTS "ShippingZone_province_key" ON "ShippingZone"("province");
CREATE UNIQUE INDEX IF NOT EXISTS "AdminUser_email_key" ON "AdminUser"("email");
CREATE UNIQUE INDEX IF NOT EXISTS "AdminSession_tokenHash_key" ON "AdminSession"("tokenHash");
CREATE INDEX IF NOT EXISTS "AdminSession_adminId_expiresAt_idx" ON "AdminSession"("adminId", "expiresAt");
CREATE INDEX IF NOT EXISTS "AuditLog_createdAt_idx" ON "AuditLog"("createdAt");
CREATE INDEX IF NOT EXISTS "RequestLimit_bucketStart_idx" ON "RequestLimit"("bucketStart");
CREATE UNIQUE INDEX IF NOT EXISTS "RequestLimit_key_bucketStart_key" ON "RequestLimit"("key", "bucketStart");

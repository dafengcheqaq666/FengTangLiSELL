  ...
  return <>
    ...
    <main id="top">
      <section className="hero">
        ...
        <div className="container"><div className="hero-content"><div className="eyebrow">仁寿吴家祠 · 当季鲜果</div><h1>蜂糖李<span className="hero-title-small">一口清脆，满口蜜甜</span></h1><p className="hero-desc">高山昼夜温差，攒足阳光与甜。树上自然成熟，果肉细嫩离核，咬开是清甜汁水，也是仁寿吴家祠盛夏最鲜活的味道。</p><div className="hero-actions"><Link className="btn-primary" href="#shop"><span>抢鲜下单</span><span>→</span></Link><div className="price-note">当季尝鲜价<br /><strong>¥59.9</strong> 起</div></div></div></div>
      ...
      <section className="origin" id="origin"><div className="container origin-grid"><div className="origin-photo reveal"><Image src={image} alt="仁寿吴家祠蜂糖李果园" fill sizes="(max-width: 900px) 100vw, 50vw" /></div><div className="origin-copy reveal"><div className="section-kicker">FROM THE MOUNTAINS</div><h2>山高、雾润，<br />才养得出这口甜</h2><p>蜂糖李喜欢阳光，也爱山里的清凉。仁寿吴家祠充足日照与昼夜温差，让果实白天积攒糖分，夜晚缓慢沉淀风味。雨雾滋润、自然生长，等果香成熟再采摘。</p><div className="data-row"><div className="data-item"><strong>26°N</strong><span>黄金种植纬度</span></div><div className="data-item"><strong>12h</strong><span>显著昼夜温差</span></div><div className="data-item"><strong>1果1剪</strong><span>人工轻采护果</span></div></div></div></div></section>
      <section className="shop" id="shop"><div className="container"><div className="section-head reveal"><div><div className="section-kicker">SEASONAL OFFER</div><h2>当季鲜甜，限量装箱</h2></div><p className="section-intro">蜂糖李赏味期短，每日按成熟度分批采摘。现在下单，把盛夏最新鲜的一口带回家。</p></div><div className="shop-wrap reveal"><div className="product-visual"><Image src={product?.image ?? image} alt={product?.name ?? "仁寿吴家祠蜂糖李"} fill sizes="(max-width: 900px) 100vw, 50vw" /><span className="product-badge">{product ? "本季热卖" : "暂时售罄"}</span></div>{product ? <ProductSelector product={product} /> : <div className="product-panel"><h2>本季已售罄</h2><p className="product-sub">感谢惦记。下一批成熟时，我们再把山里的清甜装箱送来。</p></div>}</div></div></section>
      ...
      <section className="final-cta"><div className="container"><div className="cta-card reveal"><div className="cta-copy"><div className="section-kicker">LIMITED HARVEST</div><h2>错过这一季，<br />又要再等一年</h2><p>自然成熟不催熟，产量随天气与成熟度而定。趁果香正盛，把仁寿吴家祠的蜜甜带回家。</p><Link className="btn-primary" href="#shop"><span>立即选购</span><span>↑</span></Link></div></div></div></section>
    </main>
    <footer><div className="container footer-inner"><Brand /><div className="footer-note">自然生长 · 用心挑选 · 产地直达<br />仁寿吴家祠鲜果商城</div></div></footer>
    <RevealObserver />
  </>;
}
